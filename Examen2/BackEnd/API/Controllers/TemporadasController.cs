...
namespace API.Controllers
{
    ...
    public class TemporadasController : ControllerBase
    {
        ...
        {
            var _db = _context.Temporada.Include(f => f.IdAnimeNavigation);
        ...
        {
            var temporada = await _context.Temporada.Include(f => f.IdAnimeNavigation).FirstOrDefaultAsync(m => m.Id == id);
