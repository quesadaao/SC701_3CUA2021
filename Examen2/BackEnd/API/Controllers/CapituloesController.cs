...
namespace API.Controllers
{
    ...
    public class CapituloesController : ControllerBase
    {
        ...
        {
            var _db = _context.Capitulo.Include(f => f.IdAnimeNavigation).Include(f => f.IdTemporadaNavigation);
        ...
        {
            var capitulo = await _context.Capitulo.Include(f => f.IdAnimeNavigation).Include(f => f.IdTemporadaNavigation).FirstOrDefaultAsync(m => m.Id == id);
